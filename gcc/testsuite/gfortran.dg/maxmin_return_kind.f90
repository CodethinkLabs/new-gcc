...
program test
  ...
  if (kind(max(1.0_4, b8, 3.0_4, 78.0)).ne.8) stop 17 
  if (kind(min(b4, b8, b16)).ne.16) stop 15
  if (kind(min(7.0_8, 6.8_4, 77.0_16)).ne.16) stop 16
  if (kind(min(3.0_4, b8, 0.0_4, 78.0)).ne.8) stop 17 
end
